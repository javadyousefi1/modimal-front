...
const Faq = () => {
    ...
    const faqList = [
        ...
        , { id: 2, answer: "How do I contact your Customer Service?", question: "Our modimal Customer Service Team is available Monday through Friday, 9 am - 5 pm ET, excluding holidays. You can reach us via email at hello@modimal.com (preferred and our fastest response), via chat using the icon in the right bottom cornern of our website, or via voicemail at +1(929) 460-3208. We will make sure to get back to you within 24 business hours." }
        , { id: 3, answer: "When will my order ship?", question: "you can check your order status from your panel" }
        , { id: 4, answer: "Can I cancel or modify my order?", question: "yes you can , you can cacel your order from user panel or from contact us page" }
        , { id: 5, answer: "How do your suppliers support their workers? ", question: "We prioritize supporting suppliers who uphold fair labor practices and provide equitable conditions for their workers. We request our supplier partners to ensure that their employees are treated with respect and fairness, and work in suitable conditions. Additionally, we prefer working with suppliers who adhere to social and environmental standards, contributing to a sustainable and responsible supply chain. We maintain communication with our suppliers and strive to foster a culture of ethical sourcing and accountability." }
        , { id: 6, answer: "How do you find and evaluate your suppliers?", question: "We employ a rigorous process to find and evaluate suppliers. This includes thorough research, qualification based on capabilities and adherence to standards, audits, performance monitoring, collaboration for improvement, and risk management. Our aim is to partner with suppliers who share our commitment to quality, ethics, and sustainability." }
    ]
